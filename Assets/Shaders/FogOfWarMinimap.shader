Shader "PromiseCode/Fog of War Minimap"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _FOWMinimapPositionsTexture;
            ...
            fixed4 frag(v2f IN): SV_TARGET
            {
                ...
                if(_Enabled)
                {
                    ...
                    for(int i = 0; i < _ActualUnitsCount; ++i)
                    {
                        ...
                        float2 unitIconPosition = tex2D(_FOWMinimapPositionsTexture, unitPixelCenterPos / textureResolution).rg * 1024 / _MapSize;
