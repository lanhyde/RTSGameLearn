    ...
    public class Attackable: Module
    {
        ...
        void DoShoot()
        {
            ...
            if(shell)
            {
                ...
                if(selfUnit.data.usedDamageType == UnitData.UsedDataType.UseCustomDamageValue)
                {
        ...
        /// <summary>
        /// Requires unit to shoot now in current target without reload and attack conditions check. Use only if you know why you need it.
        /// </summary>
        ...
        public virtual bool IsFireLineFree(Unit target)
        {
            ...
            // in first case will check only static obstacles, otherwise will check unit obstacles too. If no obstacles returns true.
            // If obstacles is target also returns true.
        ...
        public virtual bool IsTurretAimedToTarget(Unit target)
        {
            ...
            if(!selfUnit.tower)
            {
                ...
                return Vector3.Angle(selfForwardNoY, toOther) < 3;
            }
        ...
        public void SetShootPoints(List<Transform> shootPointsTransform) => shootPoints = shootPointsTransform.ToArray();
